...
<html>
    ...
    <body>
        <h1>Radni nalog za vozilo: ${vozilo.tip} ${vozilo.model}</h1><br /><br />
        ...
        <br />
        <h2>Popis radova:</h2><br />
        <textarea id="extra" rows="5" cols="40" placeholder="Unesite dodatne radove"></textarea>
        <br />
